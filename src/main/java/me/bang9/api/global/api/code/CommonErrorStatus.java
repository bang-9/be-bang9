...
public enum CommonErrorStatus implements BaseErrorCode {
    ...
    _INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "COMMON-500", "Internal Server Error"), _SERVICE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "COMMON-503", "Service Unavailable");
